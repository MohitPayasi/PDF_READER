...
- **Vector Embeddings**: The system creates vector embeddings using pre-trained models like **hugging face** (or other customizable models) for document retrieval.
...
- **hugging face Embeddings**: For creating embeddings (can be replaced with another embedding model if desired).
